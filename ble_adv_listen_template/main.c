...
// float distance;
// //nrf_drv_spi_t spi_instance = NRF_DRV_SPI_INSTANCE(1);
// //nrf_drv_spi_config_t spi_config_DWM;
...
//         curr_state = DRIVING;
//     //     distance = get_dist_m(&spi_instance);
...
//   //DWM init
//   // spi_init(&spi_instance, &spi_config_DWM);
...
//         } else {
//           curr_state = TURNING;
//           kobukiLeftWheelSpeedCmd = 50;
//           kobukiRightWheelSpeedCmd = -50;
//           kobukiDriveDirect(kobukiLeftWheelSpeedCmd, kobukiRightWheelSpeedCmd);
